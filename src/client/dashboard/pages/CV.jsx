             ...
             <div className={`w-[35%] flex flex-col ${t.leftCol}`}>
               ...
               <div className="flex justify-center mb-8">
                  {selectedDesign === 'ultra-formal' ? (
                    <img src={userData?.profileImage?.url || userData?.profileData?.avatar || `https://ui-avatars.com/api/?name=${userData?.username}&background=random`} alt="Profile" className="w-32 h-40 object-cover border-4 border-black grayscale" />
                  ) : (
                    <img src={userData?.profileImage?.url || userData?.profileData?.avatar || `https://ui-avatars.com/api/?name=${userData?.username}&background=random`} alt="Profile" className={`w-40 h-40 object-cover rounded-full ${selectedDesign === 'creative' ? 'border-4 border-white shadow-xl' : 'border-4 border-white/20'}`} />
                  )}
               </div>
