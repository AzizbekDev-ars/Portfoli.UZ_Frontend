...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F19] transition-colors duration-500 font-sans text-slate-800 dark:text-slate-200 flex items-center justify-center relative py-12 px-4 overflow-hidden selection:bg-indigo-500 selection:text-white">
