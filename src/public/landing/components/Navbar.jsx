    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <Link to="/login" className="px-6 py-2.5 rounded-full font-bold text-sm transition-all duration-300 bg-slate-900 text-white dark:bg-white dark:text-slate-900 hover:scale-105 hover:shadow-lg hover:shadow-indigo-500/20 active:scale-95">
            {t.nav.login}
          </Link>
        </div>
      </div>
