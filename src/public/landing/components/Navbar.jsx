    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-6">
          ...
          <Link to="/login" className="hidden sm:inline-flex px-5 py-2 rounded-full font-semibold text-sm transition-all duration-300 border border-slate-300 dark:border-white/10 dark:text-white hover:bg-slate-100 dark:hover:bg-white/5">
            {t.nav.login}
          </Link>
          <Link to="/register" className="px-5 py-2 rounded-full font-semibold text-sm transition-all duration-300 bg-slate-900 text-white dark:bg-white dark:text-slate-900 hover:scale-105 hover:shadow-lg hover:shadow-white/20">
            {t.nav.register}
          </Link>
        </div>
      </div>
